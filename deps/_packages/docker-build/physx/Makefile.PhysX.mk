...
PhysX_release_bin      := ./../../../Bin/linux64/libPhysX3_x64.a
...
$(PhysX_release_bin): $(PhysX_release_obj)
	mkdir -p `dirname ./../../../Bin/linux64/libPhysX3_x64.a`
...
PhysX_debug_bin      := ./../../../Bin/linux64/libPhysX3DEBUG_x64.a
...
$(PhysX_debug_bin): $(PhysX_debug_obj) 
	mkdir -p `dirname ./../../../Bin/linux64/libPhysX3DEBUG_x64.a`
...
PhysX_checked_bin      := ./../../../Bin/linux64/libPhysX3CHECKED_x64.a
...
$(PhysX_checked_bin): $(PhysX_checked_obj)
	mkdir -p `dirname ./../../../Bin/linux64/libPhysX3CHECKED_x64.a`
...
PhysX_profile_bin      := ./../../../Bin/linux64/libPhysX3PROFILE_x64.a
...
$(PhysX_profile_bin): $(PhysX_profile_obj)
	mkdir -p `dirname ./../../../Bin/linux64/libPhysX3PROFILE_x64.a`
